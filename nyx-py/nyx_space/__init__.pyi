...
class Frame:
    ...
    def __init__(
        ...
        orientation_id: int,
        force_inertial: bool,
        mu_km3_s2: typing.Optional[float],
        shape: typing.Optional[astro.Ellipsoid],
        frozen_epoch: typing.Optional[time.Epoch],
        *args: typing.Optional[typing.Any],
        **kwargs: typing.Optional[typing.Any],
    ) -> astro.Frame:
        """Initialize self.  See help(type(self)) for accurate signature.
    ...
    def __new__(
        ...
        shape: typing.Optional[astro.Ellipsoid] = None,
        force_inertial: bool = False,
        frozen_epoch: typing.Optional[time.Epoch] = None,
    ) -> Frame:
        """A Frame uniquely defined by its ephemeris center and orientation. Refer to FrameDetail for frames combined with parameters."""
...
class Orbit:
    ...
    def add_apoapsis_periapsis_km(
        self, delta_ra_km: float, delta_rp_km: float
    ) -> astro.Orbit:
    ...
    def eq_within(
        self, other: astro.Orbit, radial_tol_km: float, velocity_tol_km_s: float
    ) -> bool:
    ...
    def from_cartesian_npy(
        pos_vel: numpy.ndarray, epoch: time.Epoch, frame: astro.Frame
    ) -> astro.Orbit:
    ...
    def with_apoapsis_periapsis_km(
        self, new_ra_km: float, new_rp_km: float
    ) -> astro.Orbit:
