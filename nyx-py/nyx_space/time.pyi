...
class Duration:
    ...
    **Important conventions:**
    ...
    def ceil(self, duration: time.Duration) -> time.Duration:
    ...
    def floor(self, duration: time.Duration) -> time.Duration:
    ...
    def min(self, other: time.Duration) -> time.Duration:
    ...
    def round(self, duration: time.Duration) -> time.Duration:
    ...
    def to_unit(self, unit: time.Unit) -> float: ...
...
class Epoch:
    ...
    def duration_in_year(self) -> time.Duration:
        """Returns the duration since the start of the year"""

    def floor(self, duration: time.Duration) -> time.Epoch:
    ...
    @staticmethod
    def from_bdt_days(days: float) -> time.Epoch:
    ...
    @staticmethod
    def from_gpst_seconds(seconds: float) -> time.Epoch:
    ...
    def from_gregorian_at_midnight(
        year: int, month: int, day: int, time_scale: time.TimeScale
    ) -> time.Epoch:
    ...
    @staticmethod
    def from_gst_days(days: float) -> time.Epoch:
    ...
    @staticmethod
    def from_gst_nanoseconds(nanoseconds: float) -> time.Epoch:
    ...
    @staticmethod
    def from_qzsst_seconds(seconds: float) -> time.Epoch:
        """Initialize an Epoch from the number of seconds since the QZSS Time Epoch,
        defined as UTC midnight of January 5th to 6th 1980 (cf. <https://gssc.esa.int/navipedia/index.php/Time_References_in_GNSS#GPS_Time_.28GPST.29>)."""

    @staticmethod
    def from_tai_days(days: float) -> time.Epoch:
        """Initialize an Epoch from the provided TAI days since 1900 January 01 at midnight"""

    @staticmethod
    def from_tai_duration(duration: time.Duration) -> time.Epoch:
        """Creates a new Epoch from a Duration as the time difference between this epoch and TAI reference epoch."""

    @staticmethod
    def from_tai_parts(centuries: int, nanoseconds: int) -> time.Epoch:
        """Creates a new Epoch from its centuries and nanosecond since the TAI reference epoch."""

    @staticmethod
    def from_tai_seconds(seconds: float) -> time.Epoch:
        """Initialize an Epoch from the provided TAI seconds since 1900 January 01 at midnight"""

    @staticmethod
    def from_tdb_duration(duration_since_j2000: time.Duration) -> time.Epoch:
        """Initialize from Dynamic Barycentric Time (TDB) (same as SPICE ephemeris time) whose epoch is 2000 JAN 01 noon TAI."""

    @staticmethod
    def from_tdb_seconds(seconds_j2000: float) -> time.Epoch:
    ...
    @staticmethod
    def init_from_bdt_days(days: float) -> time.Epoch:
        """WARNING: Deprecated since 4.1.1; Use `from_bdt_days` instead
        Initialize an Epoch from the number of days since the BeiDou Time Epoch,
        defined as January 1st 2006 (cf. <https://gssc.esa.int/navipedia/index.php/Time_References_in_GNSS>)."""

    @staticmethod
    def init_from_bdt_nanoseconds(nanoseconds: float) -> time.Epoch:
    ...
    @staticmethod
    def init_from_bdt_seconds(seconds: float) -> time.Epoch:
        """WARNING: Deprecated since 4.1.1; Use `from_bdt_seconds` instead
        Initialize an Epoch from the number of seconds since the BeiDou Time Epoch,
        defined as January 1st 2006 (cf. <https://gssc.esa.int/navipedia/index.php/Time_References_in_GNSS>)."""

    @staticmethod
    def init_from_et_duration(duration_since_j2000: time.Duration) -> time.Epoch:
        """WARNING: Deprecated since 4.1.1; Use `from_et_duration` instead
        Initialize an Epoch from the Ephemeris Time duration past 2000 JAN 01 (J2000 reference)"""

    @staticmethod
    def init_from_et_seconds(seconds_since_j2000: float) -> time.Epoch:
        """WARNING: Deprecated since 4.1.1; Use `from_et_seconds` instead
        Initialize an Epoch from the Ephemeris Time seconds past 2000 JAN 01 (J2000 reference)"""

    @staticmethod
    def init_from_gpst_days(days: float) -> time.Epoch:
        """WARNING: Deprecated since 4.1.1; Use `from_gpst_days` instead
        Initialize an Epoch from the number of days since the GPS Time Epoch,
        defined as UTC midnight of January 5th to 6th 1980 (cf. <https://gssc.esa.int/navipedia/index.php/Time_References_in_GNSS#GPS_Time_.28GPST.29>)."""

    @staticmethod
    def init_from_gpst_nanoseconds(nanoseconds: float) -> time.Epoch:
    ...
    @staticmethod
    def init_from_gpst_seconds(seconds: float) -> time.Epoch:
    ...
    @staticmethod
    def init_from_gst_days(days: float) -> time.Epoch:
    ...
    @staticmethod
    def init_from_gst_nanoseconds(nanoseconds: float) -> time.Epoch:
    ...
    @staticmethod
    def init_from_gst_seconds(seconds: float) -> time.Epoch:
    ...
    @staticmethod
    def init_from_qzsst_seconds(seconds: float) -> time.Epoch:
        """WARNING: Deprecated since 4.1.1; Use `from_qzsst_seconds` instead
        Initialize an Epoch from the number of seconds since the QZSS Time Epoch,
        defined as UTC midnight of January 5th to 6th 1980 (cf. <https://gssc.esa.int/navipedia/index.php/Time_References_in_GNSS#GPS_Time_.28GPST.29>)."""

    @staticmethod
    def init_from_tai_days(days: float) -> time.Epoch:
        """WARNING: Deprecated since 4.1.1; Use `from_tai_days` instead
        Initialize an Epoch from the provided TAI days since 1900 January 01 at midnight"""

    @staticmethod
    def init_from_tai_duration(duration: time.Duration) -> time.Epoch:
        """WARNING: Deprecated since 4.1.1; Use `from_tai_duration` instead
        Creates a new Epoch from a Duration as the time difference between this epoch and TAI reference epoch."""

    @staticmethod
    def init_from_tai_parts(centuries: int, nanoseconds: int) -> time.Epoch:
        """WARNING: Deprecated since 4.1.1; Use `from_tai_parts` instead
        Creates a new Epoch from its centuries and nanosecond since the TAI reference epoch."""

    @staticmethod
    def init_from_tai_seconds(seconds: float) -> time.Epoch:
        """WARNING: Deprecated since 4.1.1; Use `from_tai_seconds` instead
        Initialize an Epoch from the provided TAI seconds since 1900 January 01 at midnight"""

    @staticmethod
    def init_from_tdb_duration(duration_since_j2000: time.Duration) -> time.Epoch:
        """WARNING: Deprecated since 4.1.1; Use `from_tdb_duration` instead
        Initialize from Dynamic Barycentric Time (TDB) (same as SPICE ephemeris time) whose epoch is 2000 JAN 01 noon TAI."""

    @staticmethod
    def init_from_tdb_seconds(seconds_j2000: float) -> time.Epoch:
    ...
    @staticmethod
    def init_from_tt_duration(duration: time.Duration) -> time.Epoch:
        """WARNING: Deprecated since 4.1.1; Use `from_tt_duration` instead
        Initialize an Epoch from the provided TT seconds (approximated to 32.184s delta from TAI)"""

    @staticmethod
    def init_from_tt_seconds(seconds: float) -> time.Epoch:
        """WARNING: Deprecated since 4.1.1; Use `from_tt_seconds` instead
        Initialize an Epoch from the provided TT seconds (approximated to 32.184s delta from TAI)"""

    @staticmethod
    def init_from_unix_milliseconds(milliseconds: float) -> time.Epoch:
        """WARNING: Deprecated since 4.1.1; Use `from_unix_milliseconds` instead
        Initialize an Epoch from the provided UNIX millisecond timestamp since UTC midnight 1970 January 01."""

    @staticmethod
    def init_from_unix_seconds(seconds: float) -> time.Epoch:
        """WARNING: Deprecated since 4.1.1; Use `from_unix_seconds` instead
        Initialize an Epoch from the provided UNIX second timestamp since UTC midnight 1970 January 01."""

    @staticmethod
    def init_from_utc_days(days: float) -> time.Epoch:
        """WARNING: Deprecated since 4.1.1; Use `from_utc_days` instead
        Initialize an Epoch from the provided UTC days since 1900 January 01 at midnight"""

    @staticmethod
    def init_from_utc_seconds(seconds: float) -> time.Epoch:
    ...
    def max(self, other: time.Epoch) -> time.Epoch:
    ...
    def min(self, other: time.Epoch) -> time.Epoch:
    ...
    def next_weekday_at_midnight(self, weekday: time.Weekday) -> time.Epoch: ...
    def next_weekday_at_noon(self, weekday: time.Weekday) -> time.Epoch: ...
    def precise_timescale_conversion(
        self,
        forward: bool,
        reference_epoch: time.Epoch,
    ...
    def previous(self, weekday: time.Weekday) -> time.Epoch:
        """Returns the next weekday.
    ...
    def previous_weekday_at_midnight(self, weekday: time.Weekday) -> time.Epoch: ...
    def previous_weekday_at_noon(self, weekday: time.Weekday) -> time.Epoch: ...
    def round(self, duration: time.Duration) -> time.Epoch:
    ...
    @staticmethod
    def strptime(epoch_str: str, format_str: str) -> time.Epoch:
    ...
    @staticmethod
    def system_now() -> time.Epoch:
        """Returns the computer clock in UTC"""

    def timedelta(self, other: time.Duration) -> time.Duration:
    ...
    def to_bdt_duration(self) -> time.Duration:
    ...
    def to_datetime(self, set_tz: typing.Any = None) -> datetime.datetime:
    ...
    def to_duration_in_time_scale(self, ts: time.TimeScale) -> time.Duration:
    ...
    def to_et_duration(self) -> time.Duration:
    ...
    def to_gpst_duration(self) -> time.Duration:
    ...
    def to_gst_duration(self) -> time.Duration:
    ...
    def to_jde_et(self, unit: time.Unit) -> float: ...
    def to_jde_et_days(self) -> float:
        """Returns the Ephemeris Time JDE past epoch"""

    def to_jde_et_duration(self) -> time.Duration: ...
    def to_jde_tai(self, unit: time.Unit) -> float:
    ...
    def to_jde_tai_duration(self) -> time.Duration:
    ...
    def to_jde_tdb_duration(self) -> time.Duration: ...
    ...
    def to_mjd_tt_duration(self) -> time.Duration: ...
    def to_mjd_utc(self, unit: time.Unit) -> float:
    ...
    def to_nanoseconds_in_time_scale(self, time_scale: time.TimeScale) -> int:
    ...
    def to_qzsst_duration(self) -> time.Duration:
    ...
    def to_tai(self, unit: time.Unit) -> float:
    ...
    def to_tai_duration(self) -> time.Duration:
    ...
    def to_tcb_duration(self) -> time.Duration:
    ...
    def to_tcg_duration(self) -> time.Duration:
    ...
    def to_tdb_duration(self) -> time.Duration:
    ...
    def to_time_scale(self, ts: time.TimeScale) -> time.Epoch:
    ...
    def to_tt_duration(self) -> time.Duration:
    ...
    def to_tt_since_j2k(self) -> time.Duration:
        """Returns the duration past J2000 TT"""

    def to_unix(self, unit: time.Unit) -> float:
    ...
    def to_unix_duration(self) -> time.Duration:
    ...
    def to_ut1(self, provider: Ut1Provider) -> time.Epoch:
        """Convert this epoch to Ut1"""

    def to_ut1_duration(self, provider: Ut1Provider) -> time.Duration:
        """Returns this time in a Duration past J1900 counted in UT1"""

    def to_utc(self, unit: time.Unit) -> float:
    ...
    def to_utc_duration(self) -> time.Duration:
        """Returns this time in a Duration past J1900 counted in UTC"""

    def to_utc_seconds(self) -> float:
        """Returns the number of UTC seconds since the TAI epoch"""

    def todatetime(self, set_tz: typing.Any = None) -> datetime.datetime:
        """Returns a Python datetime object from this Epoch (truncating the nanoseconds away).
        If set_tz is True, then this will return a time zone aware datetime object"""

    def ut1_offset(self, provider: Ut1Provider) -> time.Duration:
    ...
    def weekday_in_time_scale(self, time_scale: time.TimeScale) -> time.Weekday:
    ...
    def weekday_utc(self) -> time.Weekday:
        """Returns weekday in UTC timescale"""

    def with_hms(self, hours: int, minutes: int, seconds: int) -> time.Epoch:
    ...
    def with_hms_from(self, other: time.Epoch) -> time.Epoch:
    ...
    def with_hms_strict(self, hours: int, minutes: int, seconds: int) -> time.Epoch:
        """Returns a copy of self where the time is set to the provided hours, minutes, seconds
        Invalid number of hours, minutes, and seconds will overflow into their higher unit.
        Warning: this will set the subdivisions of seconds to zero."""

    def with_hms_strict_from(self, other: time.Epoch) -> time.Epoch:
    ...
    def with_time_from(self, other: time.Epoch) -> time.Epoch:
...
class MonthName:
    ...
    February: time.MonthName = ...
    January: time.MonthName = ...
    July: time.MonthName = ...
    June: time.MonthName = ...
    March: time.MonthName = ...
    May: time.MonthName = ...
    November: time.MonthName = ...
    October: time.MonthName = ...
    September: time.MonthName = ...
...
class Polynomial:
    ...
    @staticmethod
    def from_constant_offset(constant: time.Duration) -> Polynomial:
    ...
    def from_offset_and_rate(
        constant: time.Duration, rate: time.Duration
    ) -> Polynomial:
