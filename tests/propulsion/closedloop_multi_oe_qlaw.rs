...
use self::nyx::guidance::{Objective, QLaw, Thruster};
...
fn qlaw_case_b() {
    ...
    let fuel_usage = fuel_mass - final_state.fuel_mass_kg;
    println!("[qlaw_case_b] {:x}", final_state.orbit);
    println!("[qlaw_case_b] fuel usage: {:.3} kg", fuel_usage);
...
fn qlaw_case_c() {
    ...
    let fuel_usage = fuel_mass - final_state.fuel_mass_kg;
    println!("[qlaw_case_c] {:x}", final_state.orbit);
    println!("[qlaw_case_c] fuel usage: {:.3} kg", fuel_usage);
...
fn qlaw_case_d() {
    ...
    let fuel_usage = fuel_mass - final_state.fuel_mass_kg;
    println!("[qlaw_case_d] {:x}", final_state.orbit);
    println!("[qlaw_case_d] fuel usage: {:.3} kg", fuel_usage);
...
fn qlaw_case_e() {
    ...
    let fuel_usage = fuel_mass - final_state.fuel_mass_kg;
    println!("[qlaw_case_e] {:x}", final_state.orbit);
    println!("[qlaw_case_e] fuel usage: {:.3} kg", fuel_usage);
...
fn qlaw_case_f() {
    ...
    */
    ...
    let fuel_usage = fuel_mass - final_state.fuel_mass_kg;
    println!("[qlaw_case_f] {:x}", final_state.orbit);
    println!("[qlaw_case_f] fuel usage: {:.3} kg", fuel_usage);
