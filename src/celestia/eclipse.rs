...
pub fn line_of_sight(
    ...
    let observed_fok = &cosm.frame_chg_by_id(observed, eclipsing_body_id);
    let observer_fok = &cosm.frame_chg_by_id(observer, eclipsing_body_id);
