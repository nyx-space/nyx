...
impl RK for Dormand78 {
    ...
    fn b_coeffs() -> &'static [f64] {
        &[
            ...
            0.25,
            // The error coefficients are computed from a difference in GMAT, ugh.
...
/// `Dormand45GMAT` is a [Dormand-Prince integrator](https://github.com/ChristopherRabotin/GMAT/blob/37201a6290e7f7b941bc98ee973a527a5857104b/src/base/propagator/PrinceDormand45.cpp#L143).
pub struct Dormand45GMAT {}

impl RK for Dormand45GMAT {
    fn order() -> u8 {
        5
    }
    fn stages() -> usize {
